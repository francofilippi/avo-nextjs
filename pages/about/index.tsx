      ...
      <div className="py-12 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:text-center">
            <h2 className="text-base text-indigo-600 font-semibold tracking-wide uppercase">Avocados</h2>
            <p className="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">
              Surprising Facts About Avocados
            </p>
            <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
              Once you taste avocados, your life won't be the same
            </p>
          </div>
              ...
              {avoFacts.map((fact) => (
                <div key={fact.title} className="relative">
                  <dt>
                    ...
                    <p className="ml-16 text-lg leading-6 font-medium text-gray-900">{fact.title}</p>
                  </dt>
                  <dd className="mt-2 ml-16 text-base text-gray-500">{fact.content}</dd>
                </div>
              ))}
            </dl>
          </div>
        ...
        <div className="mt-12 p-6 max-w-sm mx-auto bg-white rounded-xl shadow-lg flex items-center space-x-4">
          <div className="shrink-0">
            <img className="h-12 w-12" src="/images/maluma.jpg" alt="Maluma avocado" />
          </div>
          <div>
            <div className="text-xl font-medium text-black">Maluma the best</div>
            <p className="text-slate-500">You cannot resist to its taste!</p>
          </div>
        </div>
